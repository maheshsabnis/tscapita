...
let obj2 = obj1; // assignment og obj1 to obj2
...
console.log(`After Object.assign of obj2.x = ${obj2.x} and obj3.x = ${obj3.x}`);

// Modify Obj3
obj3.x = 900;

console.log(`After modification of obj3.x to 900 obj2.x = ${obj2.x} and obj3.x = ${obj3.x}`);
